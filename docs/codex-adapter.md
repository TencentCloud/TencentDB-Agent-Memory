...
For native Codex integrations, prefer the unified SDK in [adapter-sdk.md](./adapter-sdk.md). The CLI in this document remains useful for shell hooks and smoke tests.
