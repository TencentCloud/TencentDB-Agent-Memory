...
CHECK: bash -c 'cd /home/penis/TencentDB-Agent-Memory && test -z "$(git grep -lE "appendFile|writeFile" HEAD -- src/gateway src/core/record | sed "s/^HEAD://" | grep -vxE "src/core/record/l1-writer.ts|src/gateway/apply-executor.ts|src/gateway/token.ts|src/gateway/apply-executor.test.ts|src/gateway/memory-routes.test.ts|src/gateway/consolidation/checkpoint.ts|src/gateway/consolidation/orchestrator.ts|src/gateway/consolidation/checkpoint.test.ts|src/gateway/consolidation/diff-builder.test.ts|src/gateway/consolidation/orchestrator.test.ts|src/gateway/cleanup.test.ts|src/gateway/role-files.test.ts|src/gateway/reports.ts|src/gateway/probe.test.ts|src/gateway/feedback.test.ts|src/gateway/reports.test.ts")"'
