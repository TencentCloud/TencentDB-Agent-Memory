...
export const enUS = {
  ...
  'code.register.sourceType': 'Source Type',
  'code.register.sourceTypeGit': 'Single Git Repo',
  'code.register.sourceTypeManifest': 'Repo Manifest (multi-repo)',
  'code.register.manifestUrlExtra': 'Provide the manifests repo URL (no .git suffix). Projects are cloned per the manifestnd indexed as a whole tree.',
  'code.register.manifestFile': 'Manifest File',
  'code.register.invalidManifestUrl': 'Please enter a valid HTTPS manifests repo URL (no .git suffix, e.g. https://gerrit.example.com/a/platform/manifests).',
  'code.register.manifestFileRequired': 'Please provide the manifest file path (e.g. dev/main.xml).',
