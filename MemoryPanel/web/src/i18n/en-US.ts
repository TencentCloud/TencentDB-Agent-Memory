...
export const enUS = {
  ...
  'wiki.rename.title': 'Rename',
  'wiki.rename.name': 'Wiki name',
  'wiki.rename.required': 'Name is required',
  'wiki.rename.success': 'Name updated',
  'wiki.rename.failed': 'Failed to rename wiki',
