...
export const enUS = {
  ...
  'wiki.detail.pages.navigation': 'Wiki pages',
  'wiki.detail.pages.breadcrumbs': 'Page path',
  'wiki.detail.pages.empty': 'No matching pages',
  'wiki.detail.pages.missing': 'Missing wiki page: {{ref}}',
