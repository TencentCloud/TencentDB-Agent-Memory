...
export const enUS = {
  ...
  'guide.manual.note.hermes.0': 'First chat pops an interactive Team→Agent→Task form via the native hermes clarify tool (CLI/gateway modes)',
  'guide.manual.note.hermes.1': 'To skip the form, preselect identity via static extra_headers (team-id / agent-id)',
  ...
  // ===== Session-init web link (headless no-login landing page /session-init) =====
  'sessionInit.loading': 'Loading session init info…',
  'sessionInit.title': 'Session Init · Select Team Assets',
  'sessionInit.subtitle': 'Your client is running in headless mode and cannot show an interactive form. Select the team assets to attach to this session below, then return to your terminal to continue.',
  'sessionInit.meta': 'Client: {{source}} · Session: {{session}} · Type: {{purpose}}',
  'sessionInit.purpose.init': 'First binding',
  'sessionInit.purpose.rebind': 'Rebinding (session-reset)',
  'sessionInit.field.team': 'Select Team',
  'sessionInit.field.agent': 'Select Agent',
  'sessionInit.field.task': 'Select Task',
  'sessionInit.noTask': 'No task for this session',
  'sessionInit.noTaskHint': 'Bind team and agent only; memory recall widens to the whole agent',
  'sessionInit.noTeams': 'No team assets available under your account. Create a Team / Agent in the console first.',
  'sessionInit.submit': 'Submit binding',
  'sessionInit.submitting': 'Submitting…',
  'sessionInit.done.title': 'Binding complete',
  'sessionInit.done.subtitle': 'The session is now bound to:',
  'sessionInit.done.hint': 'Return to your terminal and continue — subsequent requests will carry this identity context automatically.',
  'sessionInit.done.openHub': 'Open Memory Hub',
  'sessionInit.error.title': 'Session init failed',
  'sessionInit.error.generic': 'An unknown error occurred. Please start a new request.',
  'sessionInit.error.missing_params': 'Incomplete link: missing proxy or token parameter. Open the full link printed in your terminal.',
  'sessionInit.error.not_found': 'This link is invalid or no longer available. Start a new request to get a fresh link.',
  'sessionInit.error.expired': 'This link has expired. Start a new request to get a fresh link.',
  'sessionInit.error.consumed': 'Link already used (one-shot). To rebind, run session-reset again in your terminal.',
  'sessionInit.error.processing': 'Another request is submitting this link. Check the result shortly or retry.',
  'sessionInit.error.network_error': 'Cannot reach the Memory Proxy. Check the address and your network.',
  'sessionInit.error.candidate_load_failed': 'Failed to load team assets. Please retry shortly.',
  'sessionInit.error.agent_not_in_caller_teams': 'The selected agent does not belong to your teams.',
  'sessionInit.error.task_not_in_team': 'The selected task does not belong to that team.',
  'sessionInit.error.registration_failed': 'Registration failed. Please retry (the link is still valid).',
};
