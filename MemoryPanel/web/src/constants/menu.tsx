...
export function usePageMeta(): Record<PageId, PageMeta> {
  ...
  return {
    ...
    import_memories:  { id: 'import_memories',  label: t('menu.import_memories'), desc: t('menu.desc.import_memories'), group: t('menu.group.assets'), order: 6 },
...
export const ITEM_ICON: Record<PageId, JSX.Element> = {
  ...
  import_memories: <DownloadIcon size={16} />,
};
