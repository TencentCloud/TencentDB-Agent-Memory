...
# 已知安全的占位字符串，命中即视为非泄漏
PLACEHOLDER='xxx|your-|example|REPLACE_|placeholder|<[A-Z_]+>|\$\{[A-Z_][A-Z0-9_]*\}|dummy|fake|test-|demo-|sample|bogus|invalid-|knowledge-debug|-debug"|task-draft-generator'
