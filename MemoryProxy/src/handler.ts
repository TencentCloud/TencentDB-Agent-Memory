...
export async function handleChatCompletions(
  ...
  // openclaw 走 header 预选身份且无交互式 form UI，reset 后 session 会永远卡在
  // pending_asset_confirm，直接返回"不支持"文案。dsh/hermes headless 交给下方
  // web-link 兜底流程（签发一次性 /session-init 绑定链接）。
