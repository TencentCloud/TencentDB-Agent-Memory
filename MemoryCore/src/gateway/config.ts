...
export function loadGatewayConfig(overrides?: Partial<GatewayConfig>): GatewayConfig {
  ...
  if (topLevelEmbedding) {
    memory.embedding = {
      ...
      schemaIdentity: str(topLevelEmbedding, "schemaIdentity") ?? memory.embedding.schemaIdentity,
      modelRevision: str(topLevelEmbedding, "modelRevision") ?? memory.embedding.modelRevision,
      normalization: str(topLevelEmbedding, "normalization") ?? memory.embedding.normalization,
