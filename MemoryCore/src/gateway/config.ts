...
export function loadGatewayConfig(overrides?: Partial<GatewayConfig>): GatewayConfig {
  ...
  if (topLevelEmbedding) {
    memory.embedding = {
      ...
      maxInputTokens: num(topLevelEmbedding, "maxInputTokens") ?? memory.embedding.maxInputTokens,
      maxRetries: num(topLevelEmbedding, "maxRetries") ?? memory.embedding.maxRetries,
      retryBaseDelayMs: num(topLevelEmbedding, "retryBaseDelayMs") ?? memory.embedding.retryBaseDelayMs,
