...
/** meta_user_keys.key_value 唯一约束名（DDL 中显式命名，供冲突检测）。 */
const UX_META_USER_KEYS_KEY_VALUE = "ux_meta_user_keys_key_value";
...
/** Returns true if the error is a unique violation on meta_user_keys.key_value. */
function isUserKeyValueCollision(err: unknown): boolean {
  return uniqueViolationConstraint(err) === UX_META_USER_KEYS_KEY_VALUE;
}
  ...
  private async createSchema(): Promise<void> {
    await this.pool.query(this.sql(`
      ...
      CREATE TABLE IF NOT EXISTS meta_user_keys (
        ...
        revoked_at TEXT,
        metadata_json TEXT NOT NULL DEFAULT '{}',
        CONSTRAINT ${UX_META_USER_KEYS_KEY_VALUE} UNIQUE (key_value)
      );
