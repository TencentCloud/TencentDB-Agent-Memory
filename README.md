...
| Cross-platform adapter kit | [`GatewayMemoryClient`](./src/adapters/gateway-client/README.md) helps Codex, Claude Code, Dify, LangGraph, and custom agents integrate through the Gateway API |
| LangGraph StateGraph adapter | [`createLangGraphMemoryAdapter`](./src/adapters/langgraph/README.md) provides recall, capture, search, and session-flush nodes without adding a LangGraph runtime dependency |
...
| [`src/adapters/langgraph/README.md`](./src/adapters/langgraph/README.md) | LangGraph StateGraph node integration, identity mapping, and failure behavior |
