...
| `recall.showInjected` | `false` | Preserve auto-recall context in conversation history; default `false` strips dynamic recall snippets before persistence to reduce history growth and keep prompt-cache prefixes stable |
